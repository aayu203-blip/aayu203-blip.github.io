...
function Contact() {
  ...
  const sendEmail = () => window.open(`mailto:partstrading@gmail.com?subject=Parts Enquiry — ${form.brand || 'Heavy Equipment'}&body=${encodeURIComponent(buildBody())}`);
...
function Footer() {
  ...
  return /*#__PURE__*/React.createElement("footer", {
    ...
    href: "mailto:partstrading@gmail.com",
