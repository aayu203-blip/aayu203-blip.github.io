#!/usr/bin/env python3
"""
Script to fix WhatsApp button formatting and indentation
"""
...
def fix_whatsapp_button(html_content):
    ...
    # Find and replace the entire WhatsApp button section
    pattern = r'<!-- WhatsApp Floating Button -->\s*<a[^>]*>.*?</a>'
    
    html_content = re.sub(pattern, correct_whatsapp_button, html_content, flags=re.DOTALL)
...
def process_product_file(file_path):
    ...
    try:
        ...
        # Fix WhatsApp button
        content = fix_whatsapp_button(content)
