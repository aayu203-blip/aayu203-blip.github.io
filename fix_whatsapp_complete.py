#!/usr/bin/env python3
"""
Script to completely fix WhatsApp icon by replacing the entire SVG
"""
...
def fix_whatsapp_icon(html_content):
    ...
    pattern = r'<svg class="relative w-8 h-8 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">.*?</svg>'
